...
description: "An open table format is a metadata spec (Iceberg, Delta Lake, Hudi) that turns files in object storage into tables with ACID transactions and time travel."
